...
| --------------------------------------- | --------------------------------------------------------------------------- | ------- |
| `KZG_COMMITMENTS_INCLUSION_PROOF_DEPTH` | `floorlog2(get_generalized_index(BeaconBlockBody, 'blob_kzg_commitments'))` | *same*  |
...
| Name                                           | Mainnet                  | Minimal |
| ---------------------------------------------- | ------------------------ | ------- |
| `DATA_COLUMN_SIDECAR_SUBNET_COUNT`             | `Uint64(2**7)` (= 128)   | *same*  |
| `MIN_EPOCHS_FOR_DATA_COLUMN_SIDECARS_REQUESTS` | `Epoch(2**12)` (= 4,096) | *same*  |
